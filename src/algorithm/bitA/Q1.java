 ...
 *
 * 계산은 쉬워보여서 하나의 순열을 꼭대기 값을 계산하는 로직을 만듦
...
public class Q1 {
    ...
    public static void main(String[] args) {
        ...
        executeCompute(permArray, usedNum, 0);
    ...
    123456789 라는 기준을 정하고 거기서 부터 순차적으로 바꾸면서 계산 진행
     */
    private static void executeCompute(int[] perm, boolean[] usedNum, int depth){
